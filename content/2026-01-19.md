...
- Diane Golfouse gave a talk at the CPP workshop (Certified Programs and Proofs):

  - *Using Ghost Ownership to Verify Union-Find and Persistent Arrays in Rust*,
      by Diane Golfouse, Armaël Guéneau, Jacques-Henri Jourdan
...
- *Boucler la boucle du parcours de Morris*, by Diane Golfouse and Paul Patault ([paper on HAL](https://cnrs.hal.science/LMF/hal-05428049v1), [code on Zenodo](https://zenodo.org/records/17914344)).
...
- Exercise 1: Gnome sort ([exercise](https://guide.creusot.rs/tutorial/gnome_sort.html), [code](https://github.com/creusot-rs/tutorial/blob/main/src/ex1_gnome_sort.rs))
- Exercise 2: Linked lists ([exercise](https://guide.creusot.rs/tutorial/linked_list.html), [code](https://github.com/creusot-rs/tutorial/blob/main/src/ex2_linked_list.rs))
...
the [`AtomicI32`](https://doc.creusot.rs/creusot_std/std/sync/struct.AtomicI32.html)
...
a notion of [`AtomicInvariant`](https://doc.creusot.rs/creusot_std/ghost/invariant/struct.AtomicInvariant.html) inspired by [Iris](https://iris-project.org/), a separation logic framework in Rocq.
